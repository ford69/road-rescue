...
const envSchema = z.object({
  ...
  PAYSTACK_PUBLIC_KEY: z.preprocess(emptyToUndefined, z.string().min(1).optional()),
  PAYSTACK_WEBHOOK_SECRET: z.preprocess(emptyToUndefined, z.string().min(1).optional()),
  PAYSTACK_BASIC_PLAN_CODE: z.preprocess(emptyToUndefined, z.string().min(1).optional()),
  PAYSTACK_PROVIDER_MONTHLY_PLAN_CODE: z.preprocess(emptyToUndefined, z.string().min(1).optional()),
  PAYSTACK_PROVIDER_QUARTERLY_PLAN_CODE: z.preprocess(emptyToUndefined, z.string().min(1).optional()),
  PAYSTACK_PROVIDER_SEMIANNUAL_PLAN_CODE: z.preprocess(emptyToUndefined, z.string().min(1).optional()),
  PAYSTACK_PROVIDER_ANNUAL_PLAN_CODE: z.preprocess(emptyToUndefined, z.string().min(1).optional()),
  PROVIDER_ANNUAL_TRIAL_DAYS: z.coerce.number().int().min(0).default(30),
  PROVIDER_TRIAL_DAYS: z.coerce.number().int().min(0).optional(),
  PAYSTACK_TOKENIZATION_AMOUNT_GHS: z.coerce.number().min(0.1).default(1),
