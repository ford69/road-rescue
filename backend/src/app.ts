...
export function createApp() {
  ...
  app.get(
    '/api/v1/subscriptions/paystack/callback',
    paymentController.browserCallback,
  );
  app.get(
    '/api/subscriptions/paystack/callback',
    paymentController.browserCallback,
  );
  ...
  app.get(
    '/api/subscriptions/provider/me',
    authenticate,
    authorize('mechanic'),
    asyncHandler(providerSubscriptionController.current),
  );
  app.post(
    '/api/subscriptions/provider/checkout',
    authenticate,
    authorize('mechanic'),
    asyncHandler(providerSubscriptionController.checkout),
  );
  app.get(
    '/api/subscriptions/provider/verify/:reference',
    authenticate,
    authorize('mechanic'),
